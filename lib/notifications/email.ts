...
export function approvalRequiredTemplate(params: {
  ...
  const html = `
    <div style="font-family: system-ui, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; color: #1a1a1a;">
      <h2 style="color: #0a1628;">Hotels Vendors — Approval Request</h2>
      ...
      <table style="width: 100%; border-collapse: collapse; margin: 16px 0;">
        ...
        <tr><td style="padding: 8px; border-bottom: 1px solid #eee;"><strong>Total</strong></td><td style="padding: 8px; border-bottom: 1px solid #eee; color: #0a1628; font-weight: bold;">${params.total.toLocaleString()} ${params.currency}</td></tr>
      </table>
      <a href="${params.orderUrl}" style="display: inline-block; padding: 12px 24px; background: #0a1628; color: white; text-decoration: none; border-radius: 6px; margin-top: 16px;">Review & Approve</a>
...
export function factoringDisbursedTemplate(params: {
  ...
  const html = `
    <div style="font-family: system-ui, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px;">
      <h2 style="color: #0a1628;">Factoring Disbursement Complete</h2>
      <p>Hello ${params.supplierName},</p>
      <p>Your invoice has been funded through ${params.partnerName}:</p>
      <p style="font-size: 24px; color: #0a1628; font-weight: bold;">${params.amount.toLocaleString()} ${params.currency}</p>
...
export function smartFixTemplate(params: {
  ...
  const html = `
    <div style="font-family: system-ui, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px;">
      ...
      <a href="${params.actionUrl}" style="display: inline-block; padding: 12px 24px; background: #0a1628; color: white; text-decoration: none; border-radius: 6px;">Resolve Now</a>
    </div>
  `;
  return { subject, html };
}
...
export function welcomeTemplate(params: {
  ...
  const html = `
    <div style="font-family: system-ui, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; color: #1a1a1a;">
      <h2 style="color: #0a1628;">Welcome aboard, ${params.name}</h2>
      <p>You have successfully joined Hotels Vendors — Egypt's smartest procurement platform for hospitality.</p>
      <div style="background: #fef2f2; border-left: 4px solid #0a1628; padding: 16px; margin: 16px 0;">
      ...
      <a href="${params.loginUrl}" style="display: inline-block; padding: 12px 24px; background: #0a1628; color: white; text-decoration: none; border-radius: 6px; margin-top: 16px;">Log In to Your Account</a>
...
export function emailVerificationTemplate(params: {
  ...
  const html = `
    <div style="font-family: system-ui, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; color: #1a1a1a;">
      ...
      <a href="${params.verificationUrl}" style="display: inline-block; padding: 12px 24px; background: #0a1628; color: white; text-decoration: none; border-radius: 6px; margin-top: 16px;">Verify Email Address</a>
...
export function passwordResetTemplate(params: {
  ...
  const html = `
    <div style="font-family: system-ui, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; color: #1a1a1a;">
      ...
      <a href="${params.resetUrl}" style="display: inline-block; padding: 12px 24px; background: #0a1628; color: white; text-decoration: none; border-radius: 6px; margin-top: 16px;">Reset Password</a>
...
export function passwordResetConfirmationTemplate(params: {
  ...
  const html = `
    <div style="font-family: system-ui, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; color: #1a1a1a;">
      <h2 style="color: #0a1628;">Password updated successfully</h2>
      <p>Hello ${params.name},</p>
