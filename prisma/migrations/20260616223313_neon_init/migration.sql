...
-- CreateEnum
CREATE TYPE "TenantStatus" AS ENUM ('ACTIVE', 'ACTIVE_DEMO', 'INACTIVE', 'SUSPENDED');
...
-- CreateEnum
CREATE TYPE "UserSector" AS ENUM ('PROCUREMENT', 'CASHFLOW', 'FINTECH', 'AI', 'HOTEL', 'SUPPLIER', 'FACTORING', 'LOGISTICS');
...
-- CreateEnum
CREATE TYPE "SupplierType" AS ENUM ('FACTORY', 'WHOLESALER', 'RETAILER');
...
-- CreateEnum
CREATE TYPE "InvoPlan" AS ENUM ('STARTER', 'GROWTH', 'PROFESSIONAL');

-- CreateEnum
CREATE TYPE "InvoSubscriptionStatus" AS ENUM ('ACTIVE', 'PAST_DUE', 'CANCELLED', 'SUSPENDED');

-- CreateEnum
CREATE TYPE "DocProcessingStatus" AS ENUM ('PENDING', 'SUBMITTED', 'ACCEPTED', 'REJECTED', 'PAID');
...
-- CreateEnum
CREATE TYPE "MemoryType" AS ENUM ('FACT', 'INSIGHT', 'STRATEGY', 'LEAD', 'SUPPLIER_PROFILE', 'HOTEL_PROFILE', 'MARKET_SIGNAL', 'COMPETITOR_MOVE', 'CONVERSATION', 'ACTION_PLAN', 'MISSION');
...
-- CreateEnum
CREATE TYPE "PromoType" AS ENUM ('PERCENTAGE', 'FIXED', 'FREE_SHIPPING', 'SAAS_TRIAL');

-- CreateEnum
CREATE TYPE "DisputeStatus" AS ENUM ('OPEN', 'UNDER_INVESTIGATION', 'ESCALATED_TO_CPA', 'RESOLVED', 'CLOSED');

-- CreateEnum
CREATE TYPE "LiabilityAssignment" AS ENUM ('HOTEL', 'SUPPLIER', 'LOGISTICS', 'PLATFORM', 'SPLIT_LIABILITY');
...
CREATE TABLE "Hotel" (
    ...
    "creditUsed" DECIMAL(65,30) DEFAULT 0,
...
CREATE TABLE "Supplier" (
    ...
    "type" "SupplierType" NOT NULL DEFAULT 'WHOLESALER',
    "isVerified" BOOLEAN NOT NULL DEFAULT false,
    "returnPolicyDays" INTEGER NOT NULL DEFAULT 14,
...
CREATE TABLE "Invoice" (
    ...
    "descriptionAr" TEXT,
    "subtotal" DECIMAL(65,30) NOT NULL,
    "vatRate" DECIMAL(65,30) NOT NULL DEFAULT 14.00,
    "vatAmount" DECIMAL(65,30) NOT NULL,
    "total" DECIMAL(65,30) NOT NULL,
    "currency" TEXT NOT NULL DEFAULT 'EGP',
    "returnedAmount" DECIMAL(65,30) DEFAULT 0,
    "retentionRate" DECIMAL(65,30) DEFAULT 0,
    "retentionAmount" DECIMAL(65,30) DEFAULT 0,
    "netPayable" DECIMAL(65,30),
    ...
    "factoringCompanyId" TEXT,
    "acceleratedCashRate" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "supplierDiscountRate" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "cashDiscountDelta" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "platformFee" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "platformFeeRate" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "hotelAdminFeeRate" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "hotelAdminFeeAmount" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "EtaCredential" (
    ...
    CONSTRAINT "EtaCredential_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "FactoringRequest" (
    ...
    "advanceRate" DECIMAL(65,30) NOT NULL DEFAULT 0.90,
    "discountRate" DECIMAL(65,30) NOT NULL DEFAULT 0.02,
    "membershipDiscount" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "grossAmount" DECIMAL(65,30),
    "factoringFee" DECIMAL(65,30),
    "disbursedAmount" DECIMAL(65,30),
    "platformFee" DECIMAL(65,30) DEFAULT 0,
    "platformFeeRate" DECIMAL(65,30) DEFAULT 0.005,
...
-- CreateTable
CREATE TABLE "InvoSubscription" (
    "id" TEXT NOT NULL,
    "supplierId" TEXT NOT NULL,
    "tenantId" TEXT NOT NULL,
    "plan" "InvoPlan" NOT NULL DEFAULT 'STARTER',
    "status" "InvoSubscriptionStatus" NOT NULL DEFAULT 'ACTIVE',
    ...
    CONSTRAINT "InvoSubscription_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "DocumentProcessing" (
    ...
    "hotelInvoiceId" TEXT,
    "tenantId" TEXT NOT NULL,
    "processingFee" DECIMAL(65,30) NOT NULL DEFAULT 5.00,
    "documentsCount" INTEGER NOT NULL DEFAULT 1,
    "totalFee" DECIMAL(65,30) NOT NULL DEFAULT 5.00,
    "currency" TEXT NOT NULL DEFAULT 'EGP',
    "status" "DocProcessingStatus" NOT NULL DEFAULT 'PENDING',
    "processedAt" TIMESTAMP(3),
    "etaSubmissionRef" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "PaymentTransaction" (
    ...
    "transactionType" TEXT DEFAULT 'PAYOUT',
    "amount" DECIMAL(65,30) NOT NULL,
    "currency" TEXT NOT NULL DEFAULT 'EGP',
...
CREATE TABLE "CreditFacility" (
    ...
    "utilized" DECIMAL(65,30) NOT NULL DEFAULT 0,
...
CREATE TABLE "ConsolidatedInvoice" (
    ...
    "hotelId" TEXT NOT NULL,
    "tenantId" TEXT NOT NULL,
    "hotelAdminFeeAmount" DECIMAL(65,30) DEFAULT 0,
    "hotelAdminFeeRate" DECIMAL(65,30) DEFAULT 0.01,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "CreditLineApplication" (
    ...
    "monthlyPurchases" DECIMAL(65,30),
    "avgPaymentDays" DECIMAL(65,30),
    "existingDebt" DECIMAL(65,30),
    ...
    "creditScore" INTEGER,
    "recommendedLimit" DECIMAL(65,30),
    "aiAnalysisReport" TEXT,
    "aiRiskFlags" TEXT,
    "factoringCompanyId" TEXT,
    "approvedLimit" DECIMAL(65,30),
    "approvedInterestRate" DECIMAL(65,30),
    "approvedAt" TIMESTAMP(3),
    "rejectedReason" TEXT,
    "documents" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE UNIQUE INDEX "Order_etaSubmissionId_key" ON "Order"("etaSubmissionId");
...
-- CreateIndex
CREATE UNIQUE INDEX "EtaCredential_tenantId_key" ON "EtaCredential"("tenantId");
...
-- CreateIndex
CREATE UNIQUE INDEX "InvoSubscription_supplierId_key" ON "InvoSubscription"("supplierId");

-- CreateIndex
CREATE INDEX "InvoSubscription_status_expiresAt_idx" ON "InvoSubscription"("status", "expiresAt");

-- CreateIndex
CREATE UNIQUE INDEX "DocumentProcessing_invoiceNumber_key" ON "DocumentProcessing"("invoiceNumber");

-- CreateIndex
CREATE UNIQUE INDEX "DocumentProcessing_hotelInvoiceId_key" ON "DocumentProcessing"("hotelInvoiceId");

-- CreateIndex
CREATE INDEX "DocumentProcessing_supplierId_idx" ON "DocumentProcessing"("supplierId");

-- CreateIndex
CREATE INDEX "DocumentProcessing_status_idx" ON "DocumentProcessing"("status");
...
-- CreateIndex
CREATE INDEX "AgentRun_status_tenantId_idx" ON "AgentRun"("status", "tenantId");
...
-- CreateIndex
CREATE INDEX "SwarmJob_tenantId_idx" ON "SwarmJob"("tenantId");

-- CreateIndex
CREATE INDEX "SwarmJob_status_tenantId_idx" ON "SwarmJob"("status", "tenantId");
...
-- CreateIndex
CREATE INDEX "LeadCapture_sector_idx" ON "LeadCapture"("sector");
...
-- AddForeignKey
ALTER TABLE "EtaCredential" ADD CONSTRAINT "EtaCredential_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "InvoSubscription" ADD CONSTRAINT "InvoSubscription_supplierId_fkey" FOREIGN KEY ("supplierId") REFERENCES "Supplier"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "InvoSubscription" ADD CONSTRAINT "InvoSubscription_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DocumentProcessing" ADD CONSTRAINT "DocumentProcessing_supplierId_fkey" FOREIGN KEY ("supplierId") REFERENCES "Supplier"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DocumentProcessing" ADD CONSTRAINT "DocumentProcessing_hotelInvoiceId_fkey" FOREIGN KEY ("hotelInvoiceId") REFERENCES "Invoice"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DocumentProcessing" ADD CONSTRAINT "DocumentProcessing_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "SwarmJob" ADD CONSTRAINT "SwarmJob_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PromoCode" ADD CONSTRAINT "PromoCode_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE SET NULL ON UPDATE CASCADE;
