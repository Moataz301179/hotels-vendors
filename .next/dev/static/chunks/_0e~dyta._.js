...
function ThemeProvider({ children }) {
    _s1();
    const [accent, setAccentState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("orange");
...
_s1(ThemeProvider, "jg6SHxI6foAjHZOLXtYiDOubojg=");
_c = ThemeProvider;
var _c;
...
"[project]/components/notifications/notification-context.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function NotificationProvider({ children }) {
        ...
        "NotificationProvider.useEffect": ()=>{
            ...
            if (stored.length > 0) {
                ...
                const id = requestAnimationFrame({
                    "NotificationProvider.useEffect.id": ()=>{
                        setNotifications(stored);
                    }
                }["NotificationProvider.useEffect.id"]);
                return ({
                    "NotificationProvider.useEffect": ()=>cancelAnimationFrame(id)
                })["NotificationProvider.useEffect"];
            }
        }
    }["NotificationProvider.useEffect"], []);
        ...
        "NotificationProvider.useCallback[markAsRead]": (id)=>{
            setNotifications({
                "NotificationProvider.useCallback[markAsRead]": (prev)=>prev.map({
                        "NotificationProvider.useCallback[markAsRead]": (n)=>n.id === id ? {
                                ...n,
                                read: true
                            } : n
    ...
    const dismissNotification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NotificationProvider.useCallback[dismissNotification]": (id)=>{
            setNotifications({
                "NotificationProvider.useCallback[dismissNotification]": (prev)=>prev.filter({
                        "NotificationProvider.useCallback[dismissNotification]": (n)=>n.id !== id
                    }["NotificationProvider.useCallback[dismissNotification]"])
            }["NotificationProvider.useCallback[dismissNotification]"]);
        }
    }["NotificationProvider.useCallback[dismissNotification]"], []);
...
_s(NotificationProvider, "rOxZMI2wnqcpuuhTBC32GS3kAj0=");
...
function LanguageProvider({ children }) {
    ...
    const setLocale = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "LanguageProvider.useCallback[setLocale]": (newLocale)=>{
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                ...
                document.documentElement.dir = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2f$translations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isRTL"])(newLocale) ? "rtl" : "ltr";
            }
        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LanguageProvider.useEffect": ()=>{
            if (mounted && ("TURBOPACK compile-time value", "object") !== "undefined") {
                ...
                document.documentElement.dir = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2f$translations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isRTL"])(locale) ? "rtl" : "ltr";
            }
        }
    }["LanguageProvider.useEffect"], [
        locale,
    ...
    const value = {
        ...
        setLocale,
        toggleLocale,
        dir: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2f$translations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isRTL"])(locale) ? "rtl" : "ltr",
        isRTL: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2f$translations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isRTL"])(locale)
    };
...
_s(LanguageProvider, "wLjuvTtXHTK7FSO14slXk/A95Uk=");
_c = LanguageProvider;
...
//# sourceMappingURL=_0e~dyta._.js.map