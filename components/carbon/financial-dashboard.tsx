...
const ledgerData: LedgerRow[] = [
  {
    ...
    hotel: "Stella Di Mare Resort",
    supplier: "Nile Fresh Foods",
    amount: 45200,
    currency: "EGP",
    status: "paid",
    date: "2026-06-08",
    taxStamp: "ETA-UUID: a3f8c2d1-0042",
    ledgerHash: "0x7f3a...e2b1",
    riskScore: 92,
  },
  {
    id: "2",
    invoiceId: "INV-2026-00141",
    hotel: "Jaz Aquamarine",
    supplier: "Pyramid Linens",
    amount: 28700,
    currency: "EGP",
    status: "pending",
    date: "2026-06-07",
    taxStamp: "ETA-UUID: b4e9d3e2-0041",
    ledgerHash: "0x8a4b...f3c2",
    riskScore: 78,
  },
  {
    id: "3",
    invoiceId: "INV-2026-00140",
    hotel: "Sunrise Palace",
    supplier: "Red Sea Amenities",
    amount: 61500,
    currency: "EGP",
    status: "invoiced",
    date: "2026-06-06",
    taxStamp: "ETA-UUID: c5f0e4f3-0040",
    ledgerHash: "0x9b5c...g4d3",
    riskScore: 85,
  },
  {
    id: "4",
    invoiceId: "INV-2026-00139",
    hotel: "Baron Resort Sharm",
    supplier: "Cairo Kitchen Pro",
    amount: 128400,
    currency: "EGP",
    status: "delivered",
    date: "2026-06-05",
    taxStamp: "ETA-UUID: d6a1f5a4-0039",
    ledgerHash: "0xac6d...h5e4",
    riskScore: 91,
  },
  {
    id: "5",
    invoiceId: "INV-2026-00138",
    hotel: "Hurghada Grand",
    supplier: "Delta Maintenance",
    amount: 18900,
    currency: "EGP",
    status: "overdue",
    date: "2026-05-28",
    taxStamp: "ETA-UUID: e7b2a6b5-0038",
    ledgerHash: "0xbd7e...i6f5",
    riskScore: 42,
  },
];
        ...
        {kpis.map((kpi) => (
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "4px" }}>
              {kpi.trend === "up" ? (
                <ThumbsUp size={14} style={{ color: "#00d924" }} />
              ) : (
                <ThumbsDown size={14} style={{ color: "#df1b41" }} />
              )}
              <span
                style={{
                  fontSize: "12px",
                  fontWeight: 500,
                  color: kpi.trend === "up" ? "#00d924" : "#df1b41",
                }}
              >
                {kpi.change}
              </span>
          ...
          <div style={{ display: "flex", gap: "8px" }}>
            ...
            <button
              ...
              style={{
                ...
                borderRadius: "6px",
                backgroundColor:
                  start + pageSize >= filtered.length ? "#f7f8fa" : "#ffffff",
                color:
                  start + pageSize >= filtered.length ? "#c1c9d2" : "#1a1f36",
                cursor:
  ...
  return (
    <>
      ...
      >
        ...
        <td style={{ padding: "14px 20px", color: "#1a1f36" }}>
          {row.hotel}
        </td>
        <td style={{ padding: "14px 20px", color: "#525f7f" }}>
          {row.supplier}
        </td>
        <td
          style={{
      ...
      {expanded && (
        <tr>
          ...
          >
            ...
            >
              <MetadataCard
                label="Digital Tax Stamp"
                value={row.taxStamp}
                sublabel="ETA UUID validated"
              />
              <MetadataCard
                label="Ledger Hash"
                value={row.ledgerHash}
                sublabel="SHA-256 cryptographic proof"
              />
              <MetadataCard
...
function MetadataCard({
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: "11px", color: "#8898aa" }}>{sublabel}</div>
    </div>
  );
}
