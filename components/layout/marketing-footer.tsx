    ...
    <footer className="border-t border-white/[0.04] bg-black">
      <div className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="border-t border-white/[0.04] pt-6 pb-4">
          <div className="rounded-xl p-3 mb-4" style={{ backgroundColor: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.04)" }}>
        ...
        <div className="rounded-xl p-3 mb-6" style={{ backgroundColor: "rgba(255,255,255,0.01)", border: "1px solid rgba(255,255,255,0.03)" }}>
