  ...
  if (collapsed) {
    return (
      <div className="h-full flex flex-col items-center py-4 border-r border-white/[0.06] bg-[#12121a]">
        ...
        <button
          onClick={onToggle}
          className="p-2 rounded-lg hover:bg-white/[0.05] text-white/30 hover:text-white transition-colors"
        >
  ...
  return (
    <div className="h-full flex flex-col border-r border-white/[0.06] bg-[#12121a]">
      ...
      <div className="p-3 border-t border-white/[0.04]">
        <button className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-white/35 hover:text-white hover:bg-white/[0.03] transition-all w-full">
          <Settings size={17} />
          <span>Settings</span>
        </button>
      </div>
