  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-black flex items-center justify-center">
      <div className="max-w-lg mx-auto px-6 text-center">
        {/* Icon */}
        <div className="w-16 h-16 rounded-2xl bg-[rgba(255,176,0,0.15)] border border-[rgba(255,176,0,0.2)] flex items-center justify-center mx-auto mb-6">
          <Construction className="w-8 h-8 text-[#FFB000]" />
        </div>
        ...
        <div className="flex items-center justify-center gap-6 mb-8 text-[12px] text-white/25">
          ...
          <span className="flex items-center gap-1.5">
            <span className="w-1.5 h-1.5 rounded-full bg-[#FFB000]/60" />
            Private Sandbox
          </span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <a
            href="/invo"
            className="inline-flex items-center gap-2 px-6 py-3 bg-[#FFB000] text-white text-[14px] font-medium rounded-xl hover:bg-[#a50000] transition-colors"
          >
            View INVO Platform
