  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-black flex items-center justify-center">
      <div className="max-w-lg mx-auto px-6 text-center">
        {/* Icon */}
        <div className="w-16 h-16 rounded-2xl bg-[rgba(255,107,0,0.15)] border border-[rgba(255,107,0,0.2)] flex items-center justify-center mx-auto mb-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <a
            href="/invo"
            className="inline-flex items-center gap-2 px-6 py-3 bg-[#FF6B00] text-white text-[14px] font-medium rounded-xl hover:bg-[#a50000] transition-colors"
          >
            View INVO Platform
