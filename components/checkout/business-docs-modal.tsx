          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-white/[0.06]">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-[#8B0000]/10 border border-[#8B0000]/20 flex items-center justify-center">
            ...
            <div className="p-6">
              {success ? (
                ...
                >
                  ...
                  <button
                    onClick={onClose}
                    className="px-5 py-2.5 rounded-lg bg-[#8B0000] hover:bg-[#6B0000] text-white text-sm font-medium transition-colors"
                  >
                    Continue
                  </button>
                </motion.div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-medium text-white/60 uppercase tracking-wider flex items-center gap-2">
                      <FileCheck className="w-3.5 h-3.5 text-[#8B0000]" />
                      Commercial Registration <span className="text-[#8B0000]">*</span>
                    </label>
                    <input
                      type="text"
                      value={commercialReg}
                  ...
                  <label className="flex items-start gap-2.5 cursor-pointer">
                    <input
                      ...
                      className="mt-0.5 w-4 h-4 rounded border-white/20 bg-white/[0.04] text-[#8B0000] focus:ring-[#8B0000]/20"
                    />
