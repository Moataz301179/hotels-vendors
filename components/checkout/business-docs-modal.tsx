          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-white/[0.06]">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-accent-base/10 border border-accent-base/20 flex items-center justify-center">
                  <FileCheck className="w-4 h-4 text-accent-base" />
                </div>
                <div>
            ...
            <div className="p-6">
              {success ? (
                ...
                >
                  ...
                  <button
                    onClick={onClose}
                    className="px-5 py-2.5 rounded-lg bg-accent-base hover:bg-[#6B0000] text-white text-sm font-medium transition-colors"
                  >
                    Continue
                  </button>
                </motion.div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-medium text-white/60 uppercase tracking-wider flex items-center gap-2">
                      <Building2 className="w-3.5 h-3.5 text-accent-base" />
                      Tax ID <span className="text-accent-base">*</span>
                    </label>
                    <input
                      type="text"
                      value={taxId}
                      ...
                      maxLength={9}
                      className="w-full px-4 py-3 rounded-lg bg-white/[0.04] border border-white/[0.08] text-sm text-white placeholder:text-white/20 outline-none focus:border-accent-base/60 focus:ring-1 focus:ring-accent-base/20 transition-all"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-medium text-white/60 uppercase tracking-wider flex items-center gap-2">
                      ...
                      Commercial Registration <span className="text-accent-base">*</span>
                    </label>
                    <input
                      type="text"
                      value={commercialReg}
                  ...
                  <label className="flex items-start gap-2.5 cursor-pointer">
                    <input
                      ...
                      className="mt-0.5 w-4 h-4 rounded border-white/20 bg-white/[0.04] text-accent-base focus:ring-accent-base/20"
                    />
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-accent-base hover:bg-[#6B0000] text-white text-sm font-medium transition-all active:scale-[0.98] disabled:opacity-50 shadow-[0_0_20px_rgba(139,0,0,0.2)]"
                  >
                    {loading ? (
