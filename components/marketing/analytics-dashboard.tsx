          ...
          {KPIS.map((kpi, i) => (
            <Reveal key={kpi.label} delay={i * 0.06}>
              ...
              >
                ...
                <div className="text-[20px] font-bold text-white mb-0.5" style={{ fontFamily: "var(--font-sans)" }}>{kpi.value}</div>
          ...
          <Reveal delay={0.2}>
            <div className="lg:col-span-3 rounded-2xl p-6" style={{ backgroundColor: SC, border: `1px solid ${B1}` }}>
                  ...
                  <div key={cat.name}>
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-[12px] font-bold text-white" style={{ fontFamily: "var(--font-sans)" }}>
              ...
              <div className="mt-5 pt-4 flex items-center justify-between" style={{ borderTop: `1px solid ${B1}` }}>
                ...
                <span className="text-[16px] font-bold text-white" style={{ fontFamily: "var(--font-sans)" }}>EGP 2.38M</span>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal delay={0.25}>
            <div className="lg:col-span-2 rounded-2xl p-6" style={{ backgroundColor: SC, border: `1px solid ${B1}` }}>
                ...
                {TOP_SAVINGS.map((s, i) => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[12px] font-bold" style={{ color: "#22C55E", fontFamily: "var(--font-sans)" }}>{s.saved}</span>
                    </div>
                  </motion.div>
                ))}
              </div>
              <div className="mt-4 pt-3 flex items-center justify-between" style={{ borderTop: `1px solid ${B1}` }}>
                ...
                <span className="text-[14px] font-bold" style={{ color: "#22C55E", fontFamily: "var(--font-sans)" }}>EGP 62,200</span>
              </div>
            </div>
          </Reveal>
        </div>
