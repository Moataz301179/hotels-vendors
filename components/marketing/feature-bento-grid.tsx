      ...
      <div className="relative">
        ...
        {metric && (
          ...
          >
            ...
            <span className="text-[15px] font-bold text-white" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>
              {metric.value}
            </span>
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        ...
                        <span className="text-[16px] font-bold" style={{ color: A, fontFamily: "'Playfair Display', Georgia, serif" }}>
                          86.4%
                        </span>
                      </div>
                    </div>
