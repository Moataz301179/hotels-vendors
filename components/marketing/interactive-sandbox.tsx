        ...
        <div className="p-5 space-y-3">
          ...
          {role === "supplier" && (
            <>
              ...
              {actionBtn("Simulate INVO Mobile Dock Scan", ScanLine, runDockScan)}
          ...
          <div className="pt-3 border-t border-slate-100">
            <Link href="/register" className="flex items-center justify-center gap-2 w-full px-4 py-3 rounded-lg bg-blue-600 text-white text-sm font-semibold hover:bg-blue-700 transition-colors">
