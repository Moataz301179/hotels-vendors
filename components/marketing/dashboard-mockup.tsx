...
const kpiCards = [
  { label: "Open POs", value: "24", change: "+3", up: true, color: "#FF6B00" },
...
export function DashboardMockup() {
  ...
  return (
    ...
    >
          ...
          >
            ...
            {sidebarItems.map((item) => (
              ...
              >
                <item.icon
                  size={15}
                  style={{ color: item.active ? "#FF6B00" : "rgba(255,255,255,0.2)" }}
                />
              </div>
            ))}
          </div>
          ...
          <div className="flex-1 p-4 min-w-0">
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  <span className="text-[7px] font-bold" style={{ color: "#FF6B00" }}>AM</span>
                </div>
              </div>
            </div>
                ...
                <div className="flex items-end gap-[3px] h-12">
                  {chartBars.map((h, i) => (
                    <div
                      ...
                      style={{
                        height: `${h}%`,
                        backgroundColor: i === chartBars.length - 1 ? "#FF6B00" : "rgba(255,107,0,0.12)",
            ...
            >
              ...
              <span className="text-[7px] font-medium" style={{ color: "#FF6B00" }}>PO-2024-0892</span>
            </div>
          </div>
        </div>
      </div>
      ...
      >
        <div className="w-1.5 h-1.5 rounded-full animate-pulse" style={{ backgroundColor: "#FF6B00" }} />
        <span className="text-[8px] font-medium" style={{ color: "#FF6B00" }}>Live · ETA Connected</span>
      </motion.div>
    </motion.div>
  );
}
