...
export function SuppliersDirectory() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-10">
      {/* Header */}
      <div className="mb-10">
        <p className="text-[11px] font-semibold text-[#bef264] tracking-[0.18em] uppercase mb-3">
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full pl-11 pr-4 py-3 rounded-xl border border-white/10 bg-white/5 text-sm text-white placeholder:text-gray-600 outline-none focus:border-[#bef264]/40 transition-all"
        />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {filtered.map((supplier, i) => (
          ...
          >
            ...
            <h3 className="text-[14px] font-semibold text-white leading-snug mb-1 group-hover:text-[#bef264] transition-colors">
              {supplier.name}
            </h3>
