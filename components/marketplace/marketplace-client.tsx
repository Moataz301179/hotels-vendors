...
export default function MarketplacePage() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0F17] text-white">
      ...
      {/* Toolbar */}
      <div className="sticky top-0 z-40 border-b border-white/[0.06] bg-[#0B0F17]/90 backdrop-blur-xl">
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 py-6">
        <div className="flex gap-6">
          {/* Sidebar */}
          <aside className={`${mobileSidebarOpen ? "fixed inset-y-0 left-0 z-40 w-64 bg-[#0B0F17] border-r border-white/[0.06] p-4" : "hidden lg:block w-56 shrink-0"}`}>
            {mobileSidebarOpen && (
