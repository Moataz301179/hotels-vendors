...
export function ProductCard({
  ...
  return (
    <motion.div
      className="group relative flex flex-col rounded-xl border border-white/[0.06] bg-white/[0.02] overflow-hidden hover:border-[#8B0000]/40 transition-all duration-300"
      ...
      <div className="relative aspect-[4/3] bg-black overflow-hidden">
        ...
        <div className="absolute top-3 left-3 flex flex-col gap-1.5">
          ...
          {supplierTier === "PREMIER" && (
            <span className="px-2 py-0.5 rounded-full text-[10px] font-semibold uppercase tracking-wider bg-[#8B0000]/20 text-[#ff7a33] border border-[#8B0000]/30">
              Premier
            </span>
          )}
        </div>
      ...
      <div className="flex flex-col gap-2.5 p-4">
        ...
        <div className="flex items-center gap-2 mt-1">
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-[#8B0000] hover:bg-[#6B0512] disabled:bg-white/[0.05] disabled:text-white/20 text-white text-sm font-medium transition-all active:scale-[0.98]"
          >
