      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 top-full mt-2 w-[calc(100vw-2rem)] sm:w-96 max-w-[24rem] rounded-2xl border border-white/[0.06] bg-[#0B0F17]/95 backdrop-blur-2xl shadow-2xl shadow-black/40 z-50 overflow-hidden"
          >
            {/* Header */}
