...
const TYPE_ICON: Record<NotificationType, React.ReactNode> = {
  ...
  order: <ShoppingCart size={14} className="text-[#bef264]" />,
...
function NotificationItem({
  ...
  return (
    ...
    >
      {/* Unread indicator */}
      {!notification.read && (
        <span className="absolute top-3.5 left-3 w-1.5 h-1.5 rounded-full bg-[#bef264] ring-2 ring-[#1a1a1a]" />
      )}
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      >
        <Bell size={18} />
        {/* Demo red dot */}
        <span className="absolute top-1.5 right-1.5 w-2 h-2 rounded-full bg-[#bef264] ring-2 ring-[#121212]" />
        {/* Unread badge */}
        {unreadCount > 0 && (
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-white/[0.06]">
              <div className="flex items-center gap-2">
                ...
                {unreadCount > 0 && (
                  <span className="text-[10px] font-medium px-1.5 py-0.5 rounded-full bg-[#bef264]/30 text-[#bef264] border border-[#bef264]/20">
                    {unreadCount} new
                  </span>
                )}
              </div>
