const BADGE_STYLES: Record<string, { bg: string; text: string; label: string }> = {
  ...
  approved: { bg: "rgba(132,204,22,0.12)", text: "#FFB000", label: "Approved" },
  ...
  paid: { bg: "rgba(132,204,22,0.15)", text: "#FFB000", label: "Paid" },
  ...
  qualified: { bg: "rgba(132,204,22,0.15)", text: "#FFB000", label: "Qualified" },
  ...
  cleared: { bg: "rgba(132,204,22,0.15)", text: "#FFB000", label: "Cleared" },
  flagged: { bg: "rgba(253,126,20,0.15)", text: "#fd7e14", label: "Flagged" },
  blocked: { bg: "rgba(220,53,69,0.15)", text: "#dc3545", label: "Blocked" },
  // ETA
  submitted: { bg: "rgba(132,204,22,0.15)", text: "#FFB000", label: "Submitted" },
  ...
  funded: { bg: "rgba(132,204,22,0.15)", text: "#FFB000", label: "Funded" },
  // Subscription
  trial: { bg: "rgba(255,193,7,0.12)", text: "#FFC107", label: "Trial" },
  active: { bg: "rgba(132,204,22,0.12)", text: "#FFB000", label: "Active" },
  ...
  resolved: { bg: "rgba(132,204,22,0.15)", text: "#FFB000", label: "Resolved" },
  // Risk bands
  low: { bg: "rgba(132,204,22,0.12)", text: "#FFB000", label: "Low Risk" },
  ...
  // Compliance
  pass: { bg: "rgba(132,204,22,0.15)", text: "#FFB000", label: "Pass" },
