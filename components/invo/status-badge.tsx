const BADGE_STYLES: Record<string, { bg: string; text: string; label: string }> = {
  ...
  approved: { bg: "var(--accent-muted, rgba(255,107,0,0.12))", text: "var(--accent-base, #FF6B00)", label: "Approved" },
  ...
  paid: { bg: "var(--accent-muted, rgba(255,107,0,0.15))", text: "var(--accent-base, #FF6B00)", label: "Paid" },
  ...
  qualified: { bg: "var(--accent-muted, rgba(255,107,0,0.15))", text: "var(--accent-base, #FF6B00)", label: "Qualified" },
  ...
  cleared: { bg: "var(--accent-muted, rgba(255,107,0,0.15))", text: "var(--accent-base, #FF6B00)", label: "Cleared" },
  flagged: { bg: "rgba(253,126,20,0.15)", text: "#fd7e14", label: "Flagged" },
  blocked: { bg: "rgba(220,53,69,0.15)", text: "#dc3545", label: "Blocked" },
  // ETA
  submitted: { bg: "var(--accent-muted, rgba(255,107,0,0.15))", text: "var(--accent-base, #FF6B00)", label: "Submitted" },
  ...
  funded: { bg: "var(--accent-muted, rgba(255,107,0,0.15))", text: "var(--accent-base, #FF6B00)", label: "Funded" },
  // Subscription
  trial: { bg: "rgba(255,193,7,0.12)", text: "#FFC107", label: "Trial" },
  active: { bg: "var(--accent-muted, rgba(255,107,0,0.12))", text: "var(--accent-base, #FF6B00)", label: "Active" },
  ...
  resolved: { bg: "var(--accent-muted, rgba(255,107,0,0.15))", text: "var(--accent-base, #FF6B00)", label: "Resolved" },
  // Risk bands
  low: { bg: "var(--accent-muted, rgba(255,107,0,0.12))", text: "var(--accent-base, #FF6B00)", label: "Low Risk" },
  ...
  // Compliance
  pass: { bg: "var(--accent-muted, rgba(255,107,0,0.15))", text: "var(--accent-base, #FF6B00)", label: "Pass" },
