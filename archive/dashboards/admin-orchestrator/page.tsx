        ...
        <div className="grid lg:grid-cols-3 gap-5">
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                <BrainCircuit className="w-4 h-4 text-[#8B0000]" />
            ...
            {data?.battlePlan ? (
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 pt-2">
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#8B0000]/10 border border-[#8B0000]/20 text-[11px] font-medium text-[#8B0000]">
              ...
              {tab === "approvals" && (
                <span className="flex items-center gap-1.5">
                  ...
                  {data && data.pendingApprovals.length > 0 && (
                    <span className="min-w-[18px] h-[18px] px-1 rounded-full bg-[#8B0000] text-[10px] font-bold text-[#050505] flex items-center justify-center">
        ...
        {activeTab === "overview" && (
          ...
          >
            <div className="px-5 py-3 border-b border-white/[0.06] flex items-center justify-between">
              ...
              <Link href="/admin/swarm" className="text-[11px] text-[#8B0000] hover:text-[#6B0000] flex items-center gap-1 transition-colors">
        ...
        {activeTab === "events" && (
          ...
          >
            <div className="px-5 py-3 border-b border-white/[0.06] flex items-center justify-between">
              ...
              <Link href="/admin/health" className="text-[11px] text-[#8B0000] hover:text-[#6B0000] flex items-center gap-1 transition-colors">
          ...
          {[
            ...
            >
              ...
              <div className="flex-1">
                <h4 className="text-[13px] font-semibold text-white group-hover:text-[#8B0000] transition-colors">{link.label}</h4>
