    ...
    <div className="max-w-[1600px] mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="px-4 py-2 text-xs font-semibold bg-[#8b5cf6] hover:bg-[#b91c1c] text-white rounded-lg transition-colors flex items-center gap-2">
            <Plus size={13} />
            Add Lead
          </button>
        </div>
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <div className="relative flex-1 sm:flex-none">
            ...
            <input
              ...
              className="h-8 pl-8 pr-3 rounded-lg text-xs text-white placeholder:text-white/20 bg-white/[0.04] border border-white/[0.08] outline-none focus:border-[#8b5cf6]/40 transition-all w-full sm:w-56"
            />
          </div>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4 border-t border-white/[0.06] space-y-2">
                <button className="w-full py-2.5 rounded-lg bg-[#8b5cf6] hover:bg-[#b91c1c] text-white text-sm font-medium transition-colors flex items-center justify-center gap-2">
                  <Sparkles size={14} />
                  Enrich with AI
                </button>
