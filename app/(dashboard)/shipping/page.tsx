...
function ShipmentProgress({ status }: { status: string }) {
  ...
  const color = progress >= 100 ? "#10B981" : isDelayed ? "#EF4444" : progress > 50 ? "#022349" : "#60a5fa";
  return (
    <div className="w-full">
      ...
      <div className="flex items-center justify-between mt-1.5 px-0.5">
        ...
        <div className={`w-2 h-2 rounded-full ${progress >= 50 ? "bg-[#022349]" : "bg-white/10"}`} title="In Transit" />
                  ...
                  <div key={trip.id} className="flex items-center justify-between p-3 rounded-lg border border-white/[0.04] hover:bg-white/[0.02] transition-colors">
                    <div className="flex items-center gap-3">
                      <div className={`w-2 h-2 rounded-full ${
                        trip.status === "IN_TRANSIT" ? "bg-[#022349]" :
