      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6 mb-8">
          ...
          <div className="flex gap-2 mb-5">
            {(["scraper", "api"] as const).map((m) => (
              <button key={m} onClick={() => setMode(m)}
                className={` px-4 py-2 rounded-lg border text-sm font-semibold transition-colors ${mode === m ? "bg-slate-900 text-white border-slate-900" : "bg-white text-slate-600 border-slate-200"}`}>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <Field label="Supplier Portal">
                <select value={portalId} onChange={(e) => setPortalId(e.target.value)}
                  className="w-full border border-slate-300 focus:ring-2 focus:ring-blue-500 rounded-lg px-3.5 py-2.5 text-sm bg-white">
          ...
          <div className="mt-6 flex items-center gap-3">
            <button onClick={connect} className="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-600 text-white text-sm font-semibold rounded-lg hover:bg-blue-700 transition-colors">
...
const inputCls = "w-full border border-slate-300 focus:ring-2 focus:ring-blue-500 rounded-lg px-3.5 py-2.5 text-sm bg-white text-slate-900";
