      ...
      <div className="flex items-start justify-between mb-3">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={`w-9 h-5 rounded-full transition-colors relative ${rule.isActive ? "bg-[#3a544a]" : "bg-white/10"}`}
          >
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-xl border border-indigo-500/20 bg-indigo-500/5 p-4 space-y-3">
      ...
      <div className="flex gap-2 pt-1">
        <button type="submit" className="px-4 py-2 bg-[#314B43] hover:bg-[#3a544a] text-white text-sm rounded-lg font-medium transition-colors">
          Create Rule
        </button>
...
export default function AuthorityMatrixPage() {
  ...
  return (
    <div className="min-h-screen bg-[#646367] p-6">
      <div className="max-w-5xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          ...
          <button
            ...
            className="px-4 py-2 bg-[#314B43] hover:bg-[#3a544a] text-white text-sm rounded-lg font-medium transition-colors"
          >
        ...
        <div className="flex gap-2 mb-4">
          {(["all", "active", "inactive"] as const).map((f) => (
            <button
              key={f}
              onClick={() => setFilter(f)}
              className={`px-3 py-1.5 text-xs rounded-lg font-medium transition-colors ${filter === f ? "bg-[#314B43] text-white" : "bg-white/5 text-white/50 hover:text-white/70"}`}
            >
