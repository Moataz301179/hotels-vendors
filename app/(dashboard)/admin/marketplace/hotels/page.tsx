        ...
        <div className="px-6 py-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[13px] text-foreground-muted">View and monitor all hotel accounts on the platform</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-border-subtle">
                  ...
                  <th className="px-5 py-3 text-[11px] font-semibold text-foreground-muted uppercase tracking-wider">Location</th>
                  <th className="px-5 py-3 text-[11px] font-semibold text-foreground-muted uppercase tracking-wider">Rating</th>
                  <th className="px-5 py-3 text-[11px] font-semibold text-foreground-muted uppercase tracking-wider">Users</th>
                  <th className="px-5 py-3 text-[11px] font-semibold text-foreground-muted uppercase tracking-wider">Orders</th>
              ...
              <tbody className="divide-y divide-white/[0.04]">
                ...
                {hotels.map((h, i) => (
                  <motion.tr key={h.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: i * 0.02 }} className="hover:bg-surface-1 transition-colors">
                    ...
                    <td className="px-5 py-3.5">
                      <span className="text-[13px] text-foreground-secondary flex items-center gap-1">
                    ...
                    <td className="px-5 py-3.5">
                      <span className={`inline-flex px-2 py-0.5 rounded-full text-[11px] font-semibold uppercase ${STATUS_STYLES[h.status] || "bg-surface-2 text-foreground-muted"}`}>
                        {h.status}
                      </span>
                    </td>
                  </motion.tr>
