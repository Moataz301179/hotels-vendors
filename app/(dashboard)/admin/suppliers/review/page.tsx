      ...
      <div className="flex items-center gap-3">
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 rounded-xl bg-white/[0.04] border border-white/[0.08] text-white placeholder:text-white/15 focus:border-[#8b5cf6]/40 focus:outline-none transition-colors text-sm"
          />
        </div>
      </div>
          ...
          <div className="space-y-5">
            ...
            <div className="p-4 rounded-xl bg-white/[0.02] border border-white/[0.04]">
              <h4 className="text-xs font-semibold text-white/60 uppercase tracking-wider mb-3 flex items-center gap-2">
                <Building2 size={13} className="text-[#8b5cf6]" /> Company
              </h4>
            ...
            <div className="p-4 rounded-xl bg-white/[0.02] border border-white/[0.04]">
              <h4 className="text-xs font-semibold text-white/60 uppercase tracking-wider mb-3 flex items-center gap-2">
                <MapPin size={13} className="text-[#8b5cf6]" /> Contact
              </h4>
              <div className="grid grid-cols-2 gap-2 text-sm">
            ...
            <div className="p-4 rounded-xl bg-white/[0.02] border border-white/[0.04]">
              <h4 className="text-xs font-semibold text-white/60 uppercase tracking-wider mb-3 flex items-center gap-2">
                <Landmark size={13} className="text-[#8b5cf6]" /> Banking
              </h4>
              <div className="grid grid-cols-2 gap-2 text-sm">
            ...
            {selectedSupplier.certifications && (
              <div className="p-4 rounded-xl bg-white/[0.02] border border-white/[0.04]">
                <h4 className="text-xs font-semibold text-white/60 uppercase tracking-wider mb-3 flex items-center gap-2">
                  <ShieldCheck size={13} className="text-[#8b5cf6]" /> Certifications
                </h4>
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button
                ...
                disabled={actionLoading === selectedSupplier.id}
                className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-[#8b5cf6] hover:bg-[#8b5cf6]/80 text-white text-sm font-medium transition-colors"
              >
