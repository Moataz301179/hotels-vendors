...
export default function OrchestratorPage() {
  ...
  const platformMetrics = [
    ...
    { label: "Monthly GMV", value: `EGP ${((data?.metrics.monthlyGmv ?? 0) / 1000000).toFixed(1)}M`, icon: TrendingUp, color: "#8b5cf6" },
  ];
        ...
        <div className="px-6 py-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              disabled={planning}
              className="inline-flex items-center gap-2 px-4 py-2 bg-[#8b5cf6] hover:bg-[#6d28d9] disabled:opacity-50 text-white text-[13px] font-semibold rounded-lg transition-colors"
            >
            ...
            {data?.battlePlan ? (
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 pt-2">
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#8b5cf6]/10 border border-[#8b5cf6]/20 text-[11px] font-medium text-[#8b5cf6]">
              ...
              {tab === "approvals" && (
                <span className="flex items-center gap-1.5">
                  ...
                  {data && data.pendingApprovals.length > 0 && (
                    <span className="min-w-[18px] h-[18px] px-1 rounded-full bg-[#8b5cf6] text-[10px] font-bold text-[#050505] flex items-center justify-center">
        ...
        {activeTab === "overview" && (
          ...
          >
            <div className="px-5 py-3 border-b border-white/[0.06] flex items-center justify-between">
              ...
              <Link href="/admin/swarm" className="text-[11px] text-[#8b5cf6] hover:text-[#6d28d9] flex items-center gap-1 transition-colors">
        ...
        {activeTab === "events" && (
          ...
          >
            <div className="px-5 py-3 border-b border-white/[0.06] flex items-center justify-between">
              ...
              <Link href="/admin/health" className="text-[11px] text-[#8b5cf6] hover:text-[#6d28d9] flex items-center gap-1 transition-colors">
          ...
          {[
            ...
            >
              ...
              <div className="flex-1">
                <h4 className="text-[13px] font-semibold text-white group-hover:text-[#8b5cf6] transition-colors">{link.label}</h4>
