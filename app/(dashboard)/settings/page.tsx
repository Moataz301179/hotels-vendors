...
function Toggle({ checked, onChange }: { checked: boolean; onChange: () => void }) {
  return (
    <button
      onClick={onChange}
      className={`w-10 h-5 rounded-full transition-colors relative ${checked ? "bg-[#022349]" : "bg-white/10"}`}
    >
      <span
            ...
            <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-5">
              ...
              <SettingRow label="Platform Name" description="Displayed across the application and emails">
                <input
                  ...
                  className="w-48 px-3 py-1.5 rounded-lg bg-white/[0.02] border border-white/[0.06] text-xs text-white focus:outline-none focus:border-[#022349]/50"
                />
              </SettingRow>
            ...
            <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-5">
              ...
              <SettingRow label="API Key" description="Your platform API key for integrations">
                <div className="flex items-center gap-2">
                  ...
                  <button className="text-[10px] text-[#022349] hover:underline">Regenerate</button>
                </div>
              </SettingRow>
            </div>
          )}
                  ...
                  <div key={i} className="flex items-center justify-between py-3 border-b border-white/[0.04]">
                    ...
                    <div className="flex items-center gap-2">
                      <span className={`text-[10px] font-medium px-2 py-0.5 rounded-full ${
                        member.role === "Admin" ? "bg-[#022349]/10 text-[#022349]" :
            ...
            <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-5">
              ...
              <SettingRow label="Address" description="Registered business address">
                <input
                  ...
                  className="w-64 px-3 py-1.5 rounded-lg bg-white/[0.02] border border-white/[0.06] text-xs text-white focus:outline-none focus:border-[#022349]/50"
                />
              </SettingRow>
            ...
            <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-5">
              ...
              <div className="rounded-xl bg-white/[0.02] border border-white/[0.04] p-4 mb-4">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-[#022349]/10 text-[#022349]">Enterprise</span>
                </div>
          ...
          {activeSection === "appearance" && (
            <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-5">
              ...
              <SettingRow label="Accent Color" description="Primary brand color">
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded-full bg-[#022349] border border-white/20" />
                  <span className="text-[11px] text-white/40">#022349</span>
                </div>
              </SettingRow>
