  ...
  if (!product) {
    return (
      <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center gap-4">
        ...
        <Link
          href="/hotel/catalog"
          className="px-4 py-2 rounded-lg bg-[#800000] hover:bg-[#990000] text-white text-sm font-medium transition-colors"
        >
          Back to Catalog
        </Link>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            <div className="relative aspect-square rounded-2xl border border-white/[0.06] bg-white/[0.02] overflow-hidden">
              {product.images && product.images.length > 0 ? (
                ...
                <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-[#800000]/5 to-transparent">
              ...
              <div className="absolute top-4 left-4 flex flex-col gap-2">
                ...
                {product.supplierTier === "PREMIER" && (
                  <span className="px-3 py-1 rounded-full text-xs font-semibold bg-[#800000]/20 text-[#ff4d4d] border border-[#800000]/30">
                    Premier Supplier
                  </span>
                )}
              </div>
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <span className="px-2.5 py-1 rounded-md bg-[#800000]/15 text-[#ff4d4d] text-xs font-semibold border border-[#800000]/25">
                ...
                {bulkTiers.map((tier) => (
                  <button
                    ...
                    className={`p-2 rounded-lg border text-center transition-all ${
                      qty >= tier.qty
                        ? "bg-[#800000]/15 border-[#800000]/30 text-white"
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-[#800000] hover:bg-[#990000] disabled:bg-white/[0.05] disabled:text-white/20 text-white font-medium transition-all active:scale-[0.98]"
              >
                {addedToCart ? (
                  <>
            ...
            <div className="p-4 rounded-xl border border-white/[0.06] bg-white/[0.02]">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className={`text-[10px] px-2 py-0.5 rounded-full font-semibold uppercase ${
                  product.supplierTier === "PREMIER"
                    ? "bg-[#800000]/15 text-[#ff4d4d] border border-[#800000]/25"
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-[#800000]/15 border border-[#800000]/25 flex items-center justify-center text-sm font-bold text-[#ff4d4d]">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            <div key={item.title} className="flex items-start gap-3 p-4 rounded-xl border border-white/[0.06] bg-white/[0.02]">
              <item.icon className="w-5 h-5 text-[#ff4d4d] flex-shrink-0 mt-0.5" />
              <div>
