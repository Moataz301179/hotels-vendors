  ...
  return (
    ...
    >
      ...
      <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        ...
        <button className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-[#8b5cf6] hover:bg-[#8b5cf6]/80 text-xs text-white font-medium transition-all self-start">
          <Plus size={14} />
          Add Property
        </button>
      </motion.div>
      ...
      <motion.div variants={fadeInUp} className="flex items-center justify-between">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="pl-9 pr-4 py-1.5 rounded-lg bg-white/[0.02] border border-white/[0.06] text-xs text-white placeholder:text-white/20 focus:outline-none focus:border-[#8b5cf6]/50 w-56"
          />
        </div>
      </motion.div>
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          action={
            <button className="px-4 py-2 rounded-lg bg-[#8b5cf6] text-xs text-white font-medium">
              Add Property
            </button>
          }
        />
