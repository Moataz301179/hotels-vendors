  ...
  return (
    <div className="flex flex-col items-center gap-1.5 flex-1">
      <div className="w-full flex items-end justify-center" style={{ height: 96 }}>
        <div
          className="w-full max-w-[28px] rounded-t-sm bg-[#022349]/40 hover:bg-[#022349]/60 transition-colors"
          style={{ height: `${height}%` }}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <motion.div variants={fadeInUp} className="lg:col-span-2 rounded-xl border border-white/[0.06] bg-white/[0.02] p-5">
          <div className="flex items-center justify-between mb-5">
            ...
            <Sparkline data={sparklineData} width={100} height={32} color="#022349" />
          </div>
          {loading ? (
              ...
              {categoryBreakdown.map((cat) => (
                <div key={cat.name}>
                  ...
                  <div className="h-1.5 rounded-full bg-white/[0.04] overflow-hidden">
                    <div
                      className="h-full rounded-full bg-[#022349]/60"
                      style={{ width: `${cat.pct}%` }}
                    />
                  </div>
                </div>
