    ...
    return (
      <div className="max-w-2xl mx-auto py-16 px-4 text-center">
          ...
          {orders.map((o) => (
            <div key={o.id} className="bg-white rounded-xl border border-gray-200 p-4 text-left">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-bold text-[#8b5cf6]">EGP {o.total.toFixed(2)}</span>
              </div>
            </div>
          ))}
        </div>
        <button
          ...
          className="px-6 py-3 rounded-xl bg-[#8b5cf6] text-white font-medium hover:bg-[#6d28d9] transition-colors"
        >
          Track Orders
        </button>
      </div>
            ...
            {step === 1 && (
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 rounded-lg border border-gray-200 text-sm outline-none focus:border-[#8b5cf6]/40"
                    />
                  </div>
                  <div>
                ...
                <button
                  ...
                  className="w-full py-3 rounded-xl bg-[#8b5cf6] text-white font-medium hover:bg-[#6d28d9] disabled:bg-gray-200 disabled:text-gray-400 transition-colors"
                >
            ...
            {step === 2 && (
              ...
              >
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    onClick={() => setStep(3)}
                    className="flex-1 py-3 rounded-xl bg-[#8b5cf6] text-white font-medium hover:bg-[#6d28d9]"
                  >
                    Continue to Payment
                  </button>
                </div>
              ...
              >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-3 py-2 rounded-lg border border-gray-200 text-sm outline-none focus:border-[#8b5cf6]/40 resize-none"
                  />
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="flex-1 py-3 rounded-xl bg-[#8b5cf6] text-white font-medium hover:bg-[#6d28d9] disabled:opacity-50 transition-colors"
                  >
