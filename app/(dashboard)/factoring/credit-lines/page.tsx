      ...
      <div className="min-h-screen bg-[#000000] text-white flex items-center justify-center">
        <div className="text-center max-w-md px-6">
          ...
          <button
            ...
            className="mt-8 px-6 py-2.5 bg-[#bef264] hover:bg-[#6d28d9] text-white text-[13px] font-semibold rounded-lg transition-colors"
          >
            Back to Dashboard
          </button>
        </div>
              ...
              >
                <div
                  className={`w-10 h-10 rounded-xl flex items-center justify-center border transition-all ${
                    step === s.id
                      ? "bg-[#bef264] border-[#bef264] text-white"
                      : step > s.id
        ...
        <div className="flex items-center justify-between mt-8">
          ...
          {step < 5 ? (
            <button
              ...
              className="px-6 py-2.5 bg-[#bef264] hover:bg-[#6d28d9] text-white text-[13px] font-semibold rounded-lg transition-colors flex items-center gap-2"
            >
  ...
  return (
    <div className="p-4 rounded-xl bg-white/[0.02] border border-white/[0.06] hover:border-white/[0.1] transition-colors">
      <div className="flex items-center justify-between mb-3">
        <span className="text-[13px] text-white/70">{label} {required && <span className="text-[#bef264]">*</span>}</span>
        {file ? (
