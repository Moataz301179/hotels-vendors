    ...
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <div className="pt-24 pb-12">
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            <p className="text-[12px] font-medium text-[#DC143C] tracking-[0.15em] uppercase mb-4">
              Support
            </p>
      ...
      <div className="max-w-5xl mx-auto px-6 pb-20 space-y-16">
        ...
        <section>
          <div className="flex items-center gap-2 mb-6">
            <PlayCircle size={18} className="text-[#DC143C]" />
        ...
        <section>
          <div className="flex items-center gap-2 mb-6">
            <BookOpen size={18} className="text-[#DC143C]" />
            <h2 className="text-sm font-semibold text-white uppercase tracking-wider">
        ...
        <section>
          <div className="flex items-center gap-2 mb-6">
            <MessageCircle size={18} className="text-[#DC143C]" />
            <h2 className="text-sm font-semibold text-white uppercase tracking-wider">
              Still Need Help?
            </h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <a
              ...
              className="rounded-xl border border-white/[0.08] bg-white/[0.02] p-5 flex items-center gap-4 hover:border-[#DC143C]/30 transition-colors"
            >
