...
const RED = "#DC143C";
const RED_DIM = "rgba(220,20,60,0.12)";
          ...
          <div className="flex-1 max-w-2xl">
            <div className="relative flex items-center">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-white/[0.08] bg-white/[0.04] text-sm text-white placeholder:text-white/25 outline-none focus:border-white/[0.16] transition-all"
              />
              {search && (
                <button
                  onClick={() => setSearch("")}
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 py-6 flex gap-6">
        ...
        >
          ...
          <div
            ...
            style={{ borderColor: RED_GLOW, background: RED_DIM }}
          >
            ...
            <Link
              href="/register"
              className="mt-3 block w-full text-center py-2 text-[11px] font-medium text-white rounded-lg"
              style={{ background: RED }}
            >
              Become a Member
            </Link>
            ...
            >
              {filtered.map((product, i) => (
                <motion.div
                  ...
                  className="group relative flex flex-col rounded-xl border border-white/[0.06] bg-white/[0.02] overflow-hidden hover:border-white/[0.12] hover:bg-white/[0.03] transition-all duration-300"
                >
                  {/* Image */}
                  ...
                  <div className="flex flex-col gap-2 p-4">
                    <div className="flex items-center gap-2">
                      <span className="text-[10px] uppercase tracking-wider font-bold" style={{ color: RED }}>
                    ...
                    <div className="flex items-center gap-2 pt-1">
                      ...
                      <button
                        ...
                        className="flex items-center justify-center px-3 py-2.5 rounded-xl text-white transition-all"
                        style={{ background: RED }}
                      >
