    ...
    <main style={{ backgroundColor: "#0c0c12", color: "#ffffff", minHeight: "100vh" }}>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid md:grid-cols-3 gap-4">
            {tiers.map((tier) => (
              <div
                key={tier.name}
                className="rounded-2xl p-7 flex flex-col transition-all hover:border-[#f5870a]/10"
                style={{
                  backgroundColor: tier.highlighted ? "#12121a" : "#12121a",
                  border: tier.highlighted ? "1px solid rgba(245,135,10,0.2)" : "1px solid rgba(255,255,255,0.06)",
                }}
              >
                {tier.highlighted && (
                  <span className="text-[10px] font-medium text-[#f5870a] uppercase tracking-wider mb-3">Most Popular</span>
                )}
                <tier.icon size={20} className="mb-3" style={{ color: tier.highlighted ? "#f5870a" : "rgba(255,255,255,0.3)" }} />
                ...
                <ul className="space-y-3 mb-8 flex-1">
                  {tier.features.map((f) => (
                    <li key={f} className="flex items-start gap-2.5">
                      <Check size={14} className="flex-shrink-0 mt-0.5" style={{ color: "#f5870a" }} />
                ...
                <Link
                  ...
                  style={tier.highlighted
                    ? { backgroundColor: "#f5870a", color: "#07090f" }
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-6 text-center">
          ...
          <Link href="/register" className="inline-flex items-center gap-2 px-6 py-3 text-[13px] font-medium rounded-xl transition-all hover:shadow-[0_0_30px_rgba(245,135,10,0.2)]" style={{ backgroundColor: "#f5870a", color: "#07090f" }}>
