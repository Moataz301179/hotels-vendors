        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          >
            ...
            >
              The Story of
              <br />
              <span className="text-[#DC143C]">Smarter Procurement</span>
            </motion.h1>
            <motion.p
              variants={fadeUp}
            ...
            <motion.div variants={fadeUp} className="mt-8 flex flex-wrap items-center gap-4">
              <Link
                href="/register"
                className="group px-6 py-3.5 text-[14px] font-medium bg-[#DC143C] text-white hover:bg-[#b91031] rounded-lg transition-colors flex items-center gap-2"
              >
                Join the Platform
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-4xl mx-auto">
            {[
              ...
              >
                ...
                <a
                  href="#"
                  className="inline-flex items-center gap-1 text-[12px] font-medium text-[#DC143C] hover:text-[#b91c1c] transition-colors"
                >
        ...
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          >
            ...
            <h2 className="text-[36px] sm:text-[48px] font-bold text-white tracking-[-0.03em] leading-tight">
              Be part of the{" "}
              <span className="text-[#DC143C]">procurement revolution</span>
            </h2>
