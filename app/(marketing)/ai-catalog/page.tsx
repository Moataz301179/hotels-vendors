    ...
    <main className="bg-slate-50 min-h-screen pt-16">
      <div className="max-w-7xl mx-auto px-5 lg:px-8 py-14">
        ...
        <section className="max-w-3xl">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-slate-900 mt-3 leading-tight">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-600 text-white text-sm font-semibold rounded-md hover:bg-blue-700 transition-colors"
            >
            ...
            <Link
              href="/register"
              className="inline-flex items-center px-5 py-2.5 bg-slate-900 text-white text-sm font-semibold rounded-md hover:bg-slate-800"
            >
              Get started free
            </Link>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-lg p-6 md:p-8">
            ...
            <div className="mt-6 rounded-md border border-dashed border-slate-300 bg-slate-50 p-8 text-center">
              ...
              <button
                onClick={() => inputRef.current?.click()}
                disabled={uploading}
                className="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-slate-900 text-white text-sm font-semibold rounded-md hover:bg-slate-800 disabled:opacity-50"
              >
                Browse file
              </button>
              <input
            ...
            <div className="mt-5 flex items-center justify-end">
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-600 text-white text-sm font-semibold rounded-md hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                {uploading ? (
                  <>
