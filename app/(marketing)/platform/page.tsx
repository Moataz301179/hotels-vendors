  ...
  return (
    <main style={{ backgroundColor: "#0B0F17", color: "#ffffff", minHeight: "100vh" }}>
      ...
      <section className="pt-28 pb-16 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[600px] h-[400px] rounded-full blur-[120px] pointer-events-none" style={{ background: "radial-gradient(circle, rgba(255,107,0,0.03) 0%, transparent 70%)" }} />
        <div className="relative z-10 mx-auto max-w-7xl px-6">
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/sandbox" className="inline-flex items-center gap-2 px-6 py-3 text-[13px] font-medium rounded-xl transition-all hover:shadow-[0_0_30px_rgba(255,107,0,0.2)]" style={{ backgroundColor: "#FF6B00", color: "#000000" }}>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-6 space-y-4">
          {pillars.map((p) => (
            <div key={p.title} className="rounded-2xl p-6 md:p-8 transition-all hover:border-[#FF6B00]/10" style={{ backgroundColor: "#0B0F17", border: "1px solid rgba(255,255,255,0.06)" }}>
      ...
      {/* Compliance Bar */}
      <section className="py-12 border-y" style={{ borderColor: "rgba(255,255,255,0.04)", backgroundColor: "#0B0F17" }}>
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={b.label} className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0" style={{ backgroundColor: "rgba(255,107,0,0.08)" }}>
                  <b.icon size={16} style={{ color: "#FF6B00" }} />
                </div>
                <div>
                  <p className="text-[11px] font-medium text-white/60">{b.label}</p>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-6 text-center">
          <Cpu size={32} className="mx-auto mb-6" style={{ color: "#FF6B00" }} />
