    ...
    <main className="bg-slate-50 min-h-screen pt-16">
      <div className="max-w-7xl mx-auto px-5 lg:px-8 py-10">
        <header className="mb-10 max-w-3xl">
          <div className="text-[11px] font-semibold uppercase tracking-widest text-blue-600">Integrations</div>
          <h1 className="text-3xl font-bold text-slate-900 mt-1">ERP Integrations</h1>
...
<div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={e.name} className="bg-white border border-slate-200 rounded-lg p-4">
              ...
              <span className="inline-block text-[10px] mt-2 px-1.5 py-0.5 rounded bg-blue-50 text-blue-800 border border-blue-200">{e.dir}</span>
            </div>
          ))}
        </div>
        <div className="mt-10">
