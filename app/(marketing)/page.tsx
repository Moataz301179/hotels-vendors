      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-8 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-7">
          ...
          <Link href="/register/hotel"
            className="text-[12px] font-bold px-5 py-2.5 rounded-full transition-all hover:-translate-y-0.5 "
    ...
    <section className="py-32 lg:py-[160px]" style={{ background: "var(--bg-canvas)" }}>
      <div className="max-w-[1280px] mx-auto px-6 md:px-8">
        ...
        <div className="mt-12 text-center">
          <a href="#how-it-works"
            className="inline-flex items-center gap-2 text-[14px] font-semibold px-8 py-3.5 rounded-full transition-all hover:-translate-y-0.5 "
            style={{ background: "var(--fg-success)", color: "var(--bg-canvas)" }}>
            See How We Fix This →
          </a>
        </div>
      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <Link href="/register/hotel"
              className="inline-flex items-center gap-2 mt-8 text-[14px] font-semibold px-8 py-3.5 rounded-full transition-all hover:-translate-y-0.5 "
              style={{ background: "var(--fg-success)", color: "var(--bg-canvas)" }}>
              Request Hotel Demo →
            </Link>
          </div>
    ...
    <section className="py-24 lg:py-[120px] relative overflow-hidden" style={{ background: "var(--bg-canvas)" }}>
      ...
      <div className="relative z-10 max-w-[700px] mx-auto px-6 text-center">
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/register/hotel"
            className="inline-flex items-center justify-center gap-2 px-8 py-3.5 text-[14px] font-semibold rounded-full transition-all hover:-translate-y-0.5 "
            style={{ background: "var(--fg-success)", color: "var(--bg-canvas)" }}>
            Start Free Today →
          </Link>
          <Link href="/register/supplier"
