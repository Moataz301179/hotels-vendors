      ...
      <section className="py-16" style={{ backgroundColor: "#050505" }}>
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <Eye size={24} className="mb-4" style={{ color: "#39FF14" }} />
            ...
            <div>
              <Target size={24} className="mb-4" style={{ color: "#39FF14" }} />
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            {[
              { icon: Shield, title: "Compliance First", desc: "ETA e-invoicing, FRA anti-fraud, and cryptographic audit trails are built in — not bolted on.", color: "#39FF14" },
