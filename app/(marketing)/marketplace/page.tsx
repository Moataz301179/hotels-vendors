...
export const metadata: Metadata = {
  ...
  description: "Egypt's B2B hospitality marketplace. Verified suppliers across F&B, consumables, FF&E, guest supplies, and services. Fixed-price catalogs with ETA-compliant invoicing.",
  ...
  openGraph: {
    title: "B2B Hospitality Marketplace Egypt | Verified Hotel Suppliers | HotelsVendors",
    description: "Egypt's B2B hospitality marketplace. Verified suppliers across F&B, consumables, FF&E, guest supplies, and services.",
    type: "website",
  },
};
...
const categories = [
  ...
  { name: "Services", desc: "Maintenance, pest control, laundry, security", color: "#00E5CC" },
];

const supplierFeatures = [
  { icon: Upload, title: "Catalog Upload", desc: "Upload your product catalog with bulk CSV import. Set fixed prices per hotel or per property group." },
      ...
      <section className="pt-28 pb-16 relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6">
          ...
          <h1 className="text-[clamp(30px,5vw,52px)] font-medium leading-[1.05] tracking-tight mb-5 text-white">
            Fixed-Price Catalogs.<br />ETA-Compliant Invoicing.<br /><span className="text-gradient-lime">24-Hour Settlement.</span>
          </h1>
          <p className="text-[15px] text-white/40 max-w-2xl leading-relaxed mb-8">
            Egypt&apos;s hospitality procurement marketplace. Fixed-price listings, ETA-compliant invoicing, and 24-hour settlement via embedded factoring. Built for suppliers who are done waiting 90 days to get paid.
          </p>
      ...
      <section className="py-8 border-y" style={{ borderColor: "rgba(255,255,255,0.04)", backgroundColor: "#030303" }}>
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex flex-wrap justify-center gap-8">
            {[
              { icon: Shield, label: "Verified Suppliers", desc: "KYC completed" },
