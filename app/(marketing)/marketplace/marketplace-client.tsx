          ...
          <div className="max-w-2xl mb-8">
            <div className="flex gap-2">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-10 py-3.5 rounded-xl bg-white/[0.03] border border-white/[0.06] text-sm text-white placeholder:text-white/20 outline-none focus:border-[#39ff7e]/60 transition-all"
                />
                {query && (
                  <button
                    onClick={() => setQuery("")}
            ...
            {query && (
              <p className="text-[12px] text-white/40 mt-3">
                {hasResults ? (
                  <>Showing results for <span className="text-[#39ff7e] font-medium">&ldquo;{query}&rdquo;</span></>
                ) : (
