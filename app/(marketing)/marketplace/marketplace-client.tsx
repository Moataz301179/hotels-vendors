...
const categories = [
  { name: "F&B", desc: "Food, beverages, kitchen equipment", count: "2,400+ SKUs", color: "#f5870a", image: "https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400&h=300&fit=crop" },
  { name: "Consumables", desc: "Housekeeping, chemicals, linens, toiletries", count: "1,800+ SKUs", color: "#f5870a", image: "https://images.unsplash.com/photo-1584132967334-10e028bd69f7?w=400&h=300&fit=crop" },
    ...
    <main style={{ backgroundColor: "#0c0c12", color: "#ffffff", minHeight: "100vh" }}>
      ...
      <section className="pt-28 pb-16 relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6">
          ...
          <div className="max-w-2xl mb-8">
            <div className="flex gap-2">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-10 py-3.5 rounded-xl bg-white/[0.03] border border-white/[0.06] text-sm text-white placeholder:text-white/20 outline-none focus:border-[#f5870a]/60 transition-all"
                />
                {query && (
                  <button
                    onClick={() => setQuery("")}
              ...
              <button className="px-5 py-3.5 rounded-xl flex items-center gap-2 text-[13px] font-medium" style={{ backgroundColor: "#f5870a", color: "#07090f" }}>
            ...
            {query && (
              <p className="text-[12px] text-white/40 mt-3">
                {hasResults ? (
                  <>Showing results for <span className="text-[#f5870a] font-medium">&ldquo;{query}&rdquo;</span></>
                ) : (
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/register?sector=procurement" className="inline-flex items-center gap-2 px-6 py-3 text-[13px] font-medium rounded-xl transition-all hover:shadow-[0_0_30px_rgba(245,135,10,0.2)]" style={{ backgroundColor: "#f5870a", color: "#07090f" }}>Start Selling <ArrowRight size={14} /></Link>
      ...
      <section className="py-16 relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link href="/register?sector=procurement" className="text-[12px] font-medium text-[#f5870a] hover:underline flex items-center gap-1">View all catalog <ArrowRight size={12} /></Link>
          </div>
          {filteredProducts.length > 0 ? (
                ...
                <div key={p.name} className="group rounded-xl overflow-hidden border transition-all hover:border-white/20 hover:scale-[1.02] cursor-pointer" style={{ backgroundColor: "#12121a", borderColor: "rgba(255,255,255,0.06)" }}>
                  <div className="relative h-32 overflow-hidden">
                    ...
                    <div className="absolute top-2 left-2">
                      <span className="text-[9px] font-medium px-2 py-0.5 rounded-full" style={{ backgroundColor: "rgba(245,135,10,0.15)", color: "#f5870a" }}>{p.category}</span>
                    </div>
                  </div>
                  <div className="p-3">
                    ...
                    <p className="text-[12px] font-semibold text-[#f5870a]">{p.price}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          {filteredSuppliers.length > 0 ? (
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {filteredSuppliers.map((s) => (
                <div key={s.name} className="group rounded-xl overflow-hidden transition-all hover:border-[#f5870a]/20" style={{ backgroundColor: "#12121a", border: "1px solid rgba(255,255,255,0.06)" }}>
                  {s.products.length > 0 && (
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          {s.verified && <Shield size={12} style={{ color: "#f5870a" }} />}
                        </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {supplierFeatures.map((f) => (
              <div key={f.title} className="rounded-xl p-6 transition-all hover:border-[#f5870a]/20" style={{ backgroundColor: "#12121a", border: "1px solid rgba(255,255,255,0.06)" }}>
                <f.icon size={20} className="mb-4" style={{ color: "#f5870a" }} />
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            {[
              ...
              <div key={item.step} className="text-center">
                <div className="w-12 h-12 rounded-xl flex items-center justify-center mx-auto mb-4" style={{ backgroundColor: "rgba(245,135,10,0.08)" }}>
                  <item.icon size={20} style={{ color: "#f5870a" }} />
                </div>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-6 text-center">
          ...
          <Link href="/register?sector=procurement" className="inline-flex items-center gap-2 px-6 py-3 text-[13px] font-medium rounded-xl transition-all hover:shadow-[0_0_30px_rgba(245,135,10,0.2)]" style={{ backgroundColor: "#f5870a", color: "#07090f" }}>
