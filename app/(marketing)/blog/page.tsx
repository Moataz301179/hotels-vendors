      ...
      <section className="py-16 border-b border-white/10">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <p className="text-[15px] text-white/50 max-w-2xl leading-relaxed">
            Insights on hotel procurement, ETA compliance, reverse factoring, AI
            forecasting, and supply chain optimization for Egypt&apos;s
            hospitality industry.
          </p>
          <p className="text-[13px] text-white/30 mt-2" dir="rtl">
            رؤى حول المشتريات الفندقية والامتثال الضريبي والتمويل العكسي
            والتنبؤ الذكي وتحسين سلسلة التوريد لقطاع الضيافة في مصر.
          </p>
        </div>
      </section>
