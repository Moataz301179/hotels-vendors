    ...
    <main className="bg-slate-50 min-h-screen pt-16">
      <div className="max-w-7xl mx-auto px-5 lg:px-8 py-10">
        <header className="mb-10 max-w-3xl">
          <div className="text-[11px] font-semibold uppercase tracking-widest text-blue-600">Compliance</div>
          <h1 className="text-3xl font-bold text-slate-900 mt-1">FRA Regulatory Shield</h1>
