...
const governorates = [
  { name: "Sharm El-Sheikh", type: "Coastal Hub", color: "#FFB000" },
...
const features = [
  { icon: TrendingDown, title: "Route Consolidation", desc: "Shared-route model means trucks run full, not half-empty. AI matches multi-supplier loads to minimize empty miles across the Red Sea corridor.", color: "#FFB000" },
