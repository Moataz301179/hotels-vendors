    ...
    <main className="bg-slate-50 min-h-screen pt-16">
      <div className="max-w-7xl mx-auto px-5 lg:px-8 py-10">
        <header className="mb-10 max-w-3xl">
          <div className="text-[11px] font-semibold uppercase tracking-widest text-blue-600">Financing</div>
          <h1 className="text-3xl font-bold text-slate-900 mt-1">Oliv Financing & Credit Lines</h1>
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            <div key={f.t} className="bg-white border border-slate-200 rounded-lg p-4">
              ...
              <div className="text-xl font-bold text-slate-900 mt-1">{f.v}</div>
        ...
        <div className="mt-10"><Link href="/register" className="inline-flex items-center px-5 py-2.5 bg-slate-900 text-white text-sm font-semibold rounded-md hover:bg-slate-800">Get started free</Link></div>
      </div>
    </main>
  );
}
