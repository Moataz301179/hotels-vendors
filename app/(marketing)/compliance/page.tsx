...
const complianceAreas = [
  { icon: FileCheck, title: "ETA E-Invoicing", desc: "Full Egyptian Tax Authority Phase 1 & 2 e-invoicing compliance. RSA-2048 digital signing, UUID tracking, real-time submission.", color: "#84cc16" },
  { icon: Shield, title: "FRA Anti-Fraud", desc: "Aligned with Egyptian Financial Regulatory Authority guidelines. Three-way matching gate: PO + ETA UUID + Signed Digital Delivery Note.", color: "#22C55E" },
  { icon: Lock, title: "Data Protection", desc: "GDPR-aligned with encryption at rest and in transit, role-based access controls, and comprehensive audit trails.", color: "#3B82F6" },
  { icon: Fingerprint, title: "ISO/IEC 27001", desc: "Information Security Management alignment. Server-side sanitization proxies and stateless data processing architecture.", color: "#D4A843" },
  { icon: Server, title: "SOC 2 Type II", desc: "Audit-ready posture for enterprise procurement. Independent third-party validation of security, availability, and confidentiality controls.", color: "#00E5CC" },
  { icon: Eye, title: "I-Score Readiness", desc: "Clean, real-time risk parameters and repayment velocity metrics fed into corporate credit assessment systems.", color: "#FF8C00" },
];
    ...
    <main style={{ backgroundColor: "#000000", color: "#ffffff", minHeight: "100vh" }}>
      ...
      <section className="pt-28 pb-16 relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6">
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/register?sector=fintech" className="inline-flex items-center gap-2 px-6 py-3 text-[13px] font-medium rounded-xl transition-all hover:shadow-[0_0_30px_rgba(132,204,22,0.2)]" style={{ backgroundColor: "#84cc16", color: "#000000" }}>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="rounded-2xl p-6 md:p-8" style={{ backgroundColor: "#0a0a0a", border: "1px solid rgba(255,255,255,0.06)" }}>
            <div className="flex items-center gap-3 mb-4">
              <FileCheck size={20} style={{ color: "#84cc16" }} />
              <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              {[
                ...
                <div key={f} className="flex items-center gap-2 text-[12px] text-white/40">
                  <span className="w-1.5 h-1.5 rounded-full flex-shrink-0" style={{ backgroundColor: "#84cc16" }} />{f}
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {complianceAreas.map((a) => (
              <div key={a.title} className="rounded-2xl p-6 transition-all hover:border-[#84cc16]/20" style={{ backgroundColor: "#0a0a0a", border: "1px solid rgba(255,255,255,0.06)" }}>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-6 text-center">
          <Shield size={28} className="mx-auto mb-6" style={{ color: "#84cc16" }} />
