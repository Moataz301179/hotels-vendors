...
const complianceAreas = [
  { icon: FileCheck, title: "ETA E-Invoicing", desc: "Full Egyptian Tax Authority Phase 1 & 2 e-invoicing compliance. RSA-2048 digital signing, UUID tracking, real-time submission.", color: "#f5870a" },
  { icon: Shield, title: "FRA Anti-Fraud", desc: "Aligned with Egyptian Financial Regulatory Authority guidelines. Three-way matching gate: PO + ETA UUID + Signed Digital Delivery Note.", color: "#f5870a" },
    ...
    <main style={{ backgroundColor: "#0c0c12", color: "#ffffff", minHeight: "100vh" }}>
      ...
      <section className="pt-28 pb-16 relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6">
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/register?sector=fintech" className="inline-flex items-center gap-2 px-6 py-3 text-[13px] font-medium rounded-xl transition-all hover:shadow-[0_0_30px_rgba(245,135,10,0.2)]" style={{ backgroundColor: "#f5870a", color: "#07090f" }}>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="rounded-2xl p-6 md:p-8" style={{ backgroundColor: "#12121a", border: "1px solid rgba(255,255,255,0.06)" }}>
            <div className="flex items-center gap-3 mb-4">
              <FileCheck size={20} style={{ color: "#f5870a" }} />
              <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              {[
                ...
                <div key={f} className="flex items-center gap-2 text-[12px] text-white/40">
                  <span className="w-1.5 h-1.5 rounded-full flex-shrink-0" style={{ backgroundColor: "#f5870a" }} />{f}
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {complianceAreas.map((a) => (
              <div key={a.title} className="rounded-2xl p-6 transition-all hover:border-[#f5870a]/20" style={{ backgroundColor: "#12121a", border: "1px solid rgba(255,255,255,0.06)" }}>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-6 text-center">
          <Shield size={28} className="mx-auto mb-6" style={{ color: "#f5870a" }} />
