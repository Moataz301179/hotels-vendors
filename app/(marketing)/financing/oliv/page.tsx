    ...
    <main style={{ backgroundColor: "#0c0c12", color: "#ffffff", minHeight: "100vh" }}>
      ...
      <section className="pt-28 pb-16 relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border mb-6" style={{ borderColor: "#14b8a633", backgroundColor: "#14b8a610" }}>
          ...
          <h1 className="text-[clamp(28px,5vw,48px)] font-semibold leading-[1.1] tracking-tight mb-5">
            ...
            <span style={{ color: "#14b8a6" }}>Financed in 48 Hours.</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <a href="https://oliv.finance/#register" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 text-[13px] font-semibold rounded-xl transition-all hover:shadow-[0_0_30px_rgba(74,124,89,0.2)]" style={{ backgroundColor: "#14b8a6", color: "#ffffff" }}>
      ...
      {/* Trust badges */}
      <section className="py-6 border-y" style={{ borderColor: "#14b8a618" }}>
        <div className="max-w-4xl mx-auto px-6 flex flex-wrap justify-center gap-6 text-[12px] text-white/30">
          <span className="flex items-center gap-2"><Shield size={14} style={{ color: "#14b8a6" }} /> FRA Licensed</span>
          <span className="flex items-center gap-2"><Landmark size={14} style={{ color: "#14b8a6" }} /> Suez Canal Bank Backed</span>
          <span className="flex items-center gap-2"><CheckCircle2 size={14} style={{ color: "#14b8a6" }} /> EGP 30M Credit Facility</span>
          <span className="flex items-center gap-2"><Zap size={14} style={{ color: "#14b8a6" }} /> 48-Hour Funding</span>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-12">
            <span className="text-[11px] font-medium uppercase tracking-[0.15em] mb-3 block" style={{ color: "#14b8a6" }}>How It Works</span>
      ...
      {/* Benefits */}
      <section className="py-20 border-y" style={{ borderColor: "#14b8a618" }}>
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-12">
            <span className="text-[11px] font-medium uppercase tracking-[0.15em] mb-3 block" style={{ color: "#14b8a6" }}>Why Oliv</span>
      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <span className="text-[11px] font-medium uppercase tracking-[0.15em] mb-3 block" style={{ color: "#14b8a6" }}>HotelsVendors + Oliv</span>
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            ...
            <div className="rounded-xl border border-white/[0.06] bg-[#12121a] p-5">
              <div className="text-[24px] font-bold mb-1" style={{ color: "#14b8a6" }}>$30M</div>
      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <a href="https://oliv.finance/#register" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-8 py-3 text-[13px] font-semibold rounded-xl transition-all hover:shadow-[0_0_30px_rgba(74,124,89,0.25)]" style={{ backgroundColor: "#14b8a6", color: "#ffffff" }}>
