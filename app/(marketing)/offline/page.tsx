      ...
      <div className="text-center max-w-md">
        ...
        <div className="flex flex-wrap gap-3 justify-center">
          <button
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-[#f5870a] text-[#07090f] text-[13px] font-semibold hover:bg-[#f5870a]/90 transition-all hover:shadow-[0_0_20px_rgba(245,135,10,0.15)]"
          >
            <RefreshCw size={14} />
            Try Again
          </button>
