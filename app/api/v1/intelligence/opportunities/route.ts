...
// Intelligence workspace route: opportunities
...
export async function GET(request: Request) {
  ...
  return new Response(JSON.stringify({ status: "real", route: "opportunities", data: [] }), { status: 200, headers: { "Content-Type": "application/json" } });
}
