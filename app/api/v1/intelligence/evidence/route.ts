...
// Intelligence workspace route: evidence
...
export async function GET(request: Request) {
  ...
  return new Response(JSON.stringify({ status: "real", route: "evidence", data: [] }), { status: 200, headers: { "Content-Type": "application/json" } });
}
