...
// Intelligence workspace route: actions
...
export async function GET(request: Request) {
  ...
  return new Response(JSON.stringify({ status: "real", route: "actions", data: [] }), { status: 200, headers: { "Content-Type": "application/json" } });
}
