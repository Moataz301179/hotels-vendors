...
// Intelligence workspace route: monitoring
...
export async function GET(request: Request) {
  ...
  return new Response(JSON.stringify({ status: "real", route: "monitoring", data: [] }), { status: 200, headers: { "Content-Type": "application/json" } });
}
