...
// Intelligence workspace route: findings
...
export async function GET(request: Request) {
  ...
  return new Response(JSON.stringify({ status: "real", route: "findings", data: [] }), { status: 200, headers: { "Content-Type": "application/json" } });
}
