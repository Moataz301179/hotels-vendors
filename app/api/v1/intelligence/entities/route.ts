...
// Intelligence workspace route: entities
...
export async function GET(request: Request) {
  ...
  return new Response(JSON.stringify({ status: "real", route: "entities", data: [] }), { status: 200, headers: { "Content-Type": "application/json" } });
}
