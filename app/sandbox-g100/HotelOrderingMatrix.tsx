  ...
  return (
    <div className="bg-[var(--bg-canvas,#050505)] min-h-screen text-[var(--text-primary,#f0f0f0)] p-8 font-sans">
      ...
      <div className="flex items-center gap-4 mb-10 max-w-4xl mx-auto">
        <div className={`flex-1 p-4 rounded border transition-all ${cartState === "REQUISITION" ? "bg-[var(--crimson-glow,rgba(139,0,0,0.2))] border-[var(--brand-red,#8B0000)]" : "bg-[var(--bg-surface-1,#0a0a0a)] border-[var(--border-invisible,rgba(255,255,255,0.06))]"}`}>
        ...
        <div className={`flex-1 p-4 rounded border transition-all ${cartState === "PURCHASING_REVIEW" ? "bg-[var(--crimson-glow,rgba(139,0,0,0.2))] border-[var(--brand-red,#8B0000)]" : "bg-[var(--bg-surface-1,#0a0a0a)] border-[var(--border-invisible,rgba(255,255,255,0.06))]"}`}>
        ...
        <div className={`flex-1 p-4 rounded border transition-all ${cartState === "FINANCE_FINAL" ? "bg-[var(--crimson-glow,rgba(139,0,0,0.2))] border-[var(--brand-red,#8B0000)]" : "bg-[var(--bg-surface-1,#0a0a0a)] border-[var(--border-invisible,rgba(255,255,255,0.06))]"}`}>
            ...
            {cartState === "PURCHASING_REVIEW" && (
              <div>
                ...
                <div className="flex gap-4">
                  ...
                  <button onClick={() => setCartState("FINANCE_FINAL")} className="flex-1 py-3 rounded bg-[var(--brand-red,#8B0000)] text-white font-bold text-sm hover:opacity-90 transition-colors">
            ...
            {cartState === "FINANCE_FINAL" && (
              <div>
                ...
                <div className="bg-[var(--bg-surface-2,#101010)] p-4 rounded border border-[var(--border-invisible,rgba(255,255,255,0.06))] mb-6">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      placeholder="000000"
                      className="w-full bg-[var(--bg-surface-3,#1a1a1a)] border border-[var(--border-subtle,rgba(255,255,255,0.1))] text-white text-lg tracking-[0.5em] py-3 pl-10 rounded font-mono focus:outline-none focus:border-[var(--brand-red,#8B0000)]"
                    />
                  </div>
                ...
                <button 
                  ...
                  className="w-full py-4 rounded bg-[var(--brand-red,#8B0000)] text-white font-bold shadow-lg disabled:opacity-50 hover:opacity-90 transition-all flex items-center justify-center gap-2"
                >
