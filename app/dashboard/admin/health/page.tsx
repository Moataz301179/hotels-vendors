  ...
  return (
    <div className="min-h-screen bg-[#121212] text-foreground">
        ...
        <div className="mx-auto max-w-7xl px-6 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-surface-raised border border-subtle">
                <Radio
                  size={14}
      ...
      <div className="mx-auto max-w-7xl px-6 py-8 space-y-8">
        ...
        {isLoading ? (
          ...
          <EmptyState
            ...
            action={
              <button
                onClick={handleManualRefresh}
                className="px-4 py-2 rounded-lg bg-surface-raised border border-subtle text-sm text-foreground-tertiary hover:text-foreground hover:bg-surface-raised transition-all"
              >
                Retry
              </button>
            }
        ...
        {/* Services Table */}
        <div className="rounded-2xl bg-[#0f0f0f] border border-subtle p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-[14px] font-semibold text-foreground-muted uppercase tracking-wider">
              Service Health
            </h2>
          ...
          <div className="rounded-2xl bg-[#0f0f0f] border border-subtle p-6">
            ...
            <div className="space-y-2 max-h-64 overflow-y-auto pr-2">
              {pulseEvents.slice(-10).map((evt, i) => (
                <div
                  key={i}
                  className="flex items-center gap-3 text-sm text-foreground-tertiary py-2 border-b border-subtle last:border-0"
                >
                  <span
                  ...
                  <span className="truncate">
                    {evt.data.metric ? (
                      <>
                        <span className="text-foreground/80">{String(evt.data.metric)}</span>
                        {" "}
