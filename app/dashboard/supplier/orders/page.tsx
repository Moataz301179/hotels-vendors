    ...
    >
      ...
      <motion.div variants={fadeInUp} className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-foreground-tertiary mt-0.5">Manage and fulfill incoming orders</p>
        </div>
      </motion.div>
      ...
      <motion.div variants={fadeInUp} className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          return (
            <div key={stat.label} className="p-4 rounded-xl bg-surface-raised border border-subtle">
      ...
      <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2.5 rounded-lg bg-surface-raised border border-subtle text-sm text-foreground placeholder:text-foreground-muted outline-none focus:border-subtle12"
          />
        </div>
        ...
        {updateOrder && (
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <span className="text-xs text-foreground-tertiary">Current:</span>
            ...
            <div className="pt-1">
              <p className="text-xs text-foreground-tertiary mb-2">Select action:</p>
              <div className="grid gap-2">
                {availableActions.map((action) => (
                  <button
                    ...
                    className={`flex items-center justify-between px-4 py-3 rounded-lg bg-surface-raised border border-subtle text-sm text-foreground/80 hover:bg-surface-raised hover:border-subtle[0.10] transition-all disabled:opacity-50 ${action.color.replace("bg-", "hover:bg-")}`}
                  >
