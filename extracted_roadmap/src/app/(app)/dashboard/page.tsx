              ...
              {myOrders.slice(0, 5).map((o) => (
                <div key={o.id} className="flex items-center justify-between p-5">
                  <div>
                    ...
                    <div className="text-xs text-fg-3">{shortDate(o.createdAt)} · {(o.items as any[])?.length ?? 0} line(s)</div>
                  </div>
              ...
              {myTx.map((t) => (
                <div key={t.id} className="flex items-center justify-between p-5">
                  <div>
                    ...
                    <div className="text-xs text-fg-3">{(t.meta as any)?.note || t.reference} · {shortDate(t.createdAt)}</div>
                  </div>
